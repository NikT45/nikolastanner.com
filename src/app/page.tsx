    ...
    <div className="flex p-4 flex-col items-center justify-items-center justify-center min-h-screen bg-white">
      <div className="flex flex-row items-center justify-items-center">
        ...
        <div className="flex pl-32 pr-24 flex-col items-center justify-items-center">
          ...
          <button className="mt-5 w-[240px] bg-[#0B57D0] hover:bg-[#2566D4] hover:shadow-sm/30 text-white font-medium py-4 rounded-full mb-3 sm:mb-4 transition-all text-sm sm:text-base cursor-pointer">
            Schedule a call
          </button>
