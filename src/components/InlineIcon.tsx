...
export function IconPill({ children }: { children: ReactNode }) {
  return (
    <span className="inline-flex items-center gap-[0.3em] whitespace-nowrap rounded-full border border-[#d4cbc7] bg-bg-subtle px-[0.55em] py-[0.08em] leading-[1.3] align-baseline">
      {children}
    </span>
  );
}
